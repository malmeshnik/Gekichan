...
def get_task_detail_keyboard(task_id: str, project_id: str, i18n: I18nContext):
    ...
    builder.row(
        types.InlineKeyboardButton(text=i18n.get("common-back"), callback_data=f"project_tasks_{project_id}"),
...
def get_priority_keyboard(i18n: I18nContext, prefix: str = "priority"):
    builder = InlineKeyboardBuilder()
    builder.row(
        types.InlineKeyboardButton(text=i18n.get("priority-high"), callback_data=f"{prefix}_high"),
        types.InlineKeyboardButton(text=i18n.get("priority-medium"), callback_data=f"{prefix}_medium"),
        types.InlineKeyboardButton(text=i18n.get("priority-low"), callback_data=f"{prefix}_low")
    )
    return builder.as_markup()

def get_deadline_date_keyboard(i18n: I18nContext):
    builder = InlineKeyboardBuilder()
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-today"), callback_data="date_today"))
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-tomorrow"), callback_data="date_tomorrow"))
    builder.row(
        types.InlineKeyboardButton(text=i18n.get("common-weekend"), callback_data="date_weekend"),
        types.InlineKeyboardButton(text=i18n.get("common-next-week"), callback_data="date_nextweek")
    )
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-custom"), callback_data="date_custom"))
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-skip"), callback_data="date_skip"))
    return builder.as_markup()
...
def get_deadline_time_keyboard(i18n: I18nContext):
    ...
    builder.row(
        types.InlineKeyboardButton(text=i18n.get("common-morning"), callback_data="time_morning"),
        types.InlineKeyboardButton(text=i18n.get("common-evening"), callback_data="time_evening")
    )
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-custom"), callback_data="time_custom"))
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-skip"), callback_data="time_skip"))
    return builder.as_markup()
...
def get_assignee_keyboard(members: List[Dict[str, Any]], i18n: I18nContext):
    ...
    for m in members:
        user = m['user_detail']
        builder.row(types.InlineKeyboardButton(text=user['first_name'], callback_data=f"assignee_{user['id']}"))
    builder.row(types.InlineKeyboardButton(text=i18n.get("common-skip"), callback_data="assignee_skip"))
    return builder.as_markup()
